...
Ir a Lista de Precios
    [Documentation]                     Ingresar a la "Lista de precios 1" , tildar la opción "Es default"
...
Ir a Lista de Precios_2
    [Documentation]                     Ingresar a la "Lista de precios 1" , destilda la opción "Es default"
    ...                                 y hace click en "Guardar"
    click                               link=Ventas
    comprobantes_venta.Ir a Lista de Precios
    comprobantes_venta.Buscador         Lista de precios 1
...
TC_039
    ...
    KW_039.Ingresar a Comprobantes de Venta
